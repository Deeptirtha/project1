...
const getComments = async function (req, res) {
    try {
        const comments = await comentModel.find({ BlogId: req.params.BlogId, isDeleted: false });
...
const getReply = async function (req, res) {
    try {
        const comments = await comentModel.find({ CommentId: req.params.CommentId, isDeleted: false });
...
module.exports = { newComment, getComments, deleteComment,getReply,updateComment }